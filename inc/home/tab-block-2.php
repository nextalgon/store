...
if ( !function_exists( 'store_lite_tab_block_2' ) ):

    // Header Featured Post.
    function store_lite_tab_block_2( $store_lite_home_section,$repeat_times ){
        ...
        if( empty( $slide_image_1 ) && empty( $slide_image_2 ) && empty( $slide_image_3 ) ){
            $wraper_class = 'col-md-12';
        }else{
            $wraper_class = 'col-md-9';
        }
        ...
        <div class="twp-blocks twp-block-2">
            <div class="container">
                                ...
                                <div class="title-controls">
                                    <ul class="nav twp-nav-tabs twp-tabs-horizontal" role="tablist">
                                        <li role="presentation" class="active">
                                            <a tab-layout="horizontal" class="content-added" href="#new-arrive-<?php echo absint( $repeat_times ) ?>" indicator="new-arrive" main-cat="<?php echo esc_attr( $product_category ); ?>" aria-controls="new-arrive-<?php echo absint( $repeat_times ) ?>" role="tab" data-toggle="tab"><?php esc_html_e('New Arrivals','store-lite'); ?></a>
                                        </li>

                                        <li role="presentation">
                                            <a tab-layout="horizontal" href="#twp-best-seller-<?php echo absint( $repeat_times ) ?>" indicator="twp-best-seller" main-cat="<?php echo esc_attr( $product_category ); ?>" aria-controls="twp-best-seller-<?php echo absint( $repeat_times ) ?>" role="tab" data-toggle="tab"><?php esc_html_e('Best Sellers','store-lite'); ?></a>
                                        </li>

                                        <li role="presentation">
                                            <a tab-layout="horizontal" href="#best-deals-<?php echo absint( $repeat_times ) ?>" indicator="best-deals" main-cat="<?php echo esc_attr( $product_category ); ?>" aria-controls="best-deals-<?php echo absint( $repeat_times ) ?>" role="tab" data-toggle="tab"><?php esc_html_e('Best Deals','store-lite'); ?></a>
                                        </li>
                                        <?php
                                        if( $categories ){
                                            foreach( $categories as $category ){ ?>
                                                <li role="presentation">
                                                    <a tab-layout="horizontal" href="#<?php echo esc_attr( $category->slug.'-'.$repeat_times ); ?>" indicator="other-cat" main-cat="<?php echo esc_attr( $category->slug ); ?>" aria-controls="<?php echo esc_attr( $category->slug ); ?>-<?php echo absint( $repeat_times ) ?>" role="tab" data-toggle="tab"><?php echo esc_html( $category->name ); ?></a>
                                                </li>
                                            <?php }
                                        } ?>
                                    </ul>
