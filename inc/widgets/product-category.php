...
if ( !function_exists('store_lite_producta_category_widgets') ) :
     ...
     * @since 1.0.0
     */
    function store_lite_producta_category_widgets(){
        // Recent Post widget.
        register_widget('Store_Lite_Sidebar_Product_Category_Widget');

    }

endif;
add_action('widgets_init', 'store_lite_producta_category_widgets');

// Recent Post widget
if ( !class_exists('Store_Lite_Sidebar_Product_Category_Widget') ) :
     ...
     * @since 1.0.0
     */
    class Store_Lite_Sidebar_Product_Category_Widget extends Store_Lite_Widget_Base
    {
        ...
        function __construct()
        {
            ...
            $fields = array(
                ...
                'top_category' => array(
                    'label' => esc_html__('Top Product Categories:', 'store-lite'),
                    'type' => 'number',
                    'default' => 5,
                    'css' => 'max-width:60px;',
                    'min' => 1,
            ...
            parent::__construct('store-lite-product-category-layout', esc_html__('SL: Product Category Widget', 'store-lite'), $opts, array(), $fields);
        }
